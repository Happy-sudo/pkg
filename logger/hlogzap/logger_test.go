...
// testEncoderConfig encoder config for testing, copy from hlogzap
...
// humanEncoderConfig copy from hlogzap
...
func TestCoreOption(t *testing.T) {
	//loggera, _ := hlogzap.NewProduction()
	//defer loggera.Sync()
	//loggera.Info("failed to fetch url",
	//	// 强类型字段
	//	hlogzap.String("url", "http://example.com"),
	//	hlogzap.Int("attempt", 3),
	//	hlogzap.Duration("duration", time.Second),
	//)
	//loggera.With(
	//	// 强类型字段
	//	hlogzap.String("url", "http://development.com"),
	//	hlogzap.Int("attempt", 4),
	//	hlogzap.Duration("duration", time.Second*5),
